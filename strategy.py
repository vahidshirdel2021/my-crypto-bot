...
def is_reversal_family_reason(reason):
    ...
    فقط برای برچسب‌گذاری (فیلد `regime_filter_exempt` در رکورد معامله) استفاده می‌شود؛
    هیچ محافظ جهت بازاری دیگر در استراتژی وجود ندارد (گیت جهت بازار در bot.py است).
    """
